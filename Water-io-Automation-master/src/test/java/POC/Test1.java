...
//        mobileDriver.executeScript("flutter:waitFor", main.test1);
        main.test4.click();
...
//        FlutterElement incrementButton2 = finder.byValueKey("incrementButton.2");
//        main.incrementButton2.click();
...
//        mobileDriver.executeScript("flutter:setFrameSync", true);
...
//        mobileDriver.executeScript("flutter:waitFor",main.main_btn);
//        main.main_btn.click();
//        Object obj = mobileDriver.executeScript("flutter:getRenderTree");
//        System.out.println(obj);
//        main.addHydration_btn.click();

//        mobileDriver.executeScript("flutter:setFrameSync", false);

//        for (int i = 0; i < 100; i++) {
//            FlutterElement main_btn = finder.byValueKey("button_main");
//            System.out.println("---------------------" + main.main_btn);
//            System.out.println("Printing every second");
//            Thread.sleep(1000);
//        }



//        HashMap<String, Object> stringObjectsHa shMap = new HashMap<>();
...
//
//        main.btn_1.click();
//        mobileDriver.executeScript("flutter:waitFor", main.btn_ok);
//        main.btn_ok.click();
//        main.gesture_1.click();
//        mobileDriver.executeScript("flutter:waitFor", main.btn_ok);
//        main.btn_ok.click();
//        main.tab_bar.click();
//        main.ink.click();
